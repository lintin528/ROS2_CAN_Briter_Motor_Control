...
class CANReader(Node):
    ...
    def read_can_response(self):
        while self.ser.in_waiting:
            ...
            dlc = info[0] & 0x0F  # DLC
            is_standard = not (info[0] & 0x20)  # Bit5 == 0
            ...
            self.encoder_cur_speed[can_id - 1] = int.from_bytes(byte_val[1:6], byteorder='big', signed=False)
    ...
    def send_encoder_inquiry(self, mode: ReadModeSelect, target_value: list):
        ...
        self.writer.writerow(['Timestamp', 'Encoder Position', 'Target Position'])
