...
DEFAULT_WHEEL_MOVE_STEP_VEL = 500.0
...
CAN_TIMEOUT = 0.1
CAN_SPEED = 500000
CAN_INSTRUCTION_BYTE_SETSPEED = [0x02]
CAN_INSTRUCTION_BYTE_SETPOS = [0x04]
CAN_INSTRUCTION_BYTE_INQUIRY_DICT = {   
                                'CAN_INSTRUCTION_BYTE_INQUIRY_SPEED':[0x0F, 0x01],
                                'CAN_INSTRUCTION_BYTE_INQUIRY_POS':[0x0F, 0x08],
                                'CAN_INSTRUCTION_BYTE_INIT_POS':[0x07, 0x00, 0x00, 0x00, 0x00],
                            }

CAN_INQUIRY_TYPE_NUMBER = len(CAN_INSTRUCTION_BYTE_INQUIRY_DICT)
CAN_INQUIRY_FREQUENCY = 0.01  # seconds
CAN_INQUIRY_DURATION = 10.0  # seconds
